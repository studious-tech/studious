...
import { SharedCourseCard } from '@/components/dashboard/shared-course-card';
...
interface SharedCoursesListProps {
  examId: string;
  examDisplayName: string;
}

export function SharedCoursesList({ examId, examDisplayName }: SharedCoursesListProps) {
  const { 
    courses, 
    loading, 
    error, 
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">
                {searchQuery || selectedDifficulty 
                  ...
                  : `No ${examDisplayName} courses are currently available`
                }
              </p>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-2xl font-bold">{examCourses.filter(c => c.is_premium).length}</p>
