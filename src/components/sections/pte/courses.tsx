...
export function PTECourses() {
  ...
  // Extract exam ID from pathname (e.g., /pte-academic/dashboard/courses -> pte-academic)
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">
                {searchQuery || selectedDifficulty 
                  ...
                  : 'No PTE Academic courses are currently available'
                }
              </p>
            </div>
          </CardContent>
