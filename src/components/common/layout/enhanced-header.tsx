        ...
        questionTypes: [
          {
            ...
            href: '/ielts-academic/reading/multiple-choice',
            description: 'Choose the correct answer from options',
          },
          {
            name: 'True/False/Not Given',
            href: '/ielts-academic/reading/true-false',
            description: 'Identify statement accuracy',
          },
          {
            name: 'Matching Headings',
            href: '/ielts-academic/reading/matching-headings',
            description: 'Match paragraphs with headings',
          },
          {
            name: 'Summary Completion',
            href: '/ielts-academic/reading/summary-completion',
            description: 'Complete text summaries',
          },
        ],
      },
      {
        ...
        questionTypes: [
          {
            ...
            href: '/ielts-academic/listening/form-completion',
            description: 'Fill in missing information',
          },
          {
            name: 'Multiple Choice',
            href: '/ielts-academic/listening/multiple-choice',
            description: 'Select correct answers',
          },
          {
            name: 'Map Labeling',
            href: '/ielts-academic/listening/map-labeling',
            description: 'Label locations on maps',
          },
          {
            name: 'Note Completion',
            href: '/ielts-academic/listening/note-completion',
            description: 'Complete notes and outlines',
          },
        ],
      },
      {
        ...
        questionTypes: [
          {
            ...
            href: '/ielts-academic/speaking/part-1',
            description: 'Personal questions and topics',
          },
          {
            name: 'Part 2 - Long Turn',
            href: '/ielts-academic/speaking/part-2',
            description: 'Speak about a given topic',
          },
          {
            name: 'Part 3 - Discussion',
            href: '/ielts-academic/speaking/part-3',
            description: 'Abstract discussion topics',
          },
        ],
      },
      {
        ...
        questionTypes: [
          {
            ...
            href: '/ielts-academic/writing/task-1',
            description: 'Describe visual information',
          },
          {
            name: 'Task 2 - Essay',
            href: '/ielts-academic/writing/task-2',
        ...
        questionTypes: [
          {
            ...
            href: '/pte-academic/reading/mcq-single',
            description: 'Choose one correct answer',
          },
          {
            name: 'Multiple Choice (Multiple)',
            href: '/pte-academic/reading/mcq-multiple',
            description: 'Choose multiple correct answers',
          },
          {
            name: 'Reorder Paragraphs',
            href: '/pte-academic/reading/reorder-paragraphs',
            description: 'Arrange text in correct order',
          },
          {
            name: 'Fill in the Blanks',
            href: '/pte-academic/reading/fill-blanks',
        ...
        questionTypes: [
          {
            ...
            href: '/pte-academic/listening/summarize-spoken',
            description: 'Write summary of audio',
          },
          {
            name: 'Multiple Choice',
            href: '/pte-academic/listening/multiple-choice',
            description: 'Select correct answers',
          },
          {
            name: 'Fill in the Blanks',
            href: '/pte-academic/listening/fill-blanks',
            description: 'Complete missing words',
          },
          {
            name: 'Highlight Correct Summary',
            href: '/pte-academic/listening/highlight-summary',
            description: 'Choose accurate summary',
          },
        ],
      },
      {
        ...
        questionTypes: [
          {
            name: 'Read Aloud',
            href: '/pte-academic/speaking/read-aloud',
            description: 'Read text clearly and fluently',
          },
          {
            name: 'Repeat Sentence',
            href: '/pte-academic/speaking/repeat-sentence',
            description: 'Repeat heard sentences',
          },
          {
            name: 'Describe Image',
            href: '/pte-academic/speaking/describe-image',
            description: 'Describe visual content',
          },
          {
            name: 'Re-tell Lecture',
            href: '/pte-academic/speaking/retell-lecture',
            description: 'Summarize lecture content',
          },
        ],
      },
      {
        ...
        questionTypes: [
          {
            ...
            href: '/pte-academic/writing/summarize-written',
            description: 'Summarize given text',
          },
          {
            name: 'Write Essay',
            href: '/pte-academic/writing/write-essay',
            description: 'Write argumentative essay',
          },
        ],
      },
    ],
  ...
  return (
    <header>
      ...
      >
        ...
        <AnimatePresence>
          {isDropdownOpen && activeExamIndex !== null && (
            <motion.div
                ...
                {examData[activeExamIndex] && (
                  ...
                  >
                    ...
                    <div className="mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                      <Link
                        href={examData[activeExamIndex].href}
                        className="inline-flex items-center gap-3 text-xl font-bold text-gray-900 dark:text-gray-100 hover:text-accent-foreground transition-colors group"
                        onClick={() => setIsDropdownOpen(false)}
                      >
                        <span className="text-2xl">
                          {examData[activeExamIndex].icon}
                        </span>
                        <div>
                          <div className="group-hover:text-accent-foreground">
                            {examData[activeExamIndex].name}
                          </div>
                          <div className="text-sm font-normal text-gray-600 dark:text-gray-400">
                            {examData[activeExamIndex].description}
                          </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                      {examData[activeExamIndex].sections.map(
                        (section, sectionIndex) => (
                          <div key={sectionIndex} className="space-y-4">
                            ...
                            <ul className="space-y-2">
                              {section.questionTypes.map(
                                (questionType, qtIndex) => (
                                  <li key={qtIndex}>
                                    <Link
                                      href={questionType.href}
                                      className="block p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors group"
                                      onClick={() => setIsDropdownOpen(false)}
                                    >
                                      <div className="font-medium text-sm text-gray-900 dark:text-gray-100 group-hover:text-accent-foreground">
                                        {questionType.name}
                                      </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center">
                      <Link
                        href={examData[activeExamIndex].href}
                        className="inline-flex items-center gap-2 text-sm font-medium text-accent-foreground hover:text-accent-foreground/80 transition-colors"
                        onClick={() => setIsDropdownOpen(false)}
                      >
                        Start {examData[activeExamIndex].name} Practice
