        ...
        <div className="flex flex-col md:flex-row items-start justify-between  gap-4 md:gap-10 px-2 md:px-8 flex-1">
          <div className="flex flex-col items-start gap-2">
            ...
            <p className="text-neutral/50 font-medium text-base w-full md:w-4/5">
              Studious Prep helps students excel in IELTS, PTE, and UCAT exams with expert
              guidance and AI-powered resources.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-1 md:gap-4">
              ...
              <div className="flex flex-wrap md:flex-col gap-2 text-sm text-neutral items-start ">
                <Link
                  ...
                  href="/resources/free-practice-tests"
                >
                  Free Practice Tests
                </Link>
                <Link
                ...
                <Link
                  className="text-neutral/50 whitespace-nowrap font-medium"
                  href="/resources/vocabulary-builder"
                >
                  Vocabulary Builder
                </Link>
                <Link
                  className="text-neutral/50 whitespace-nowrap font-medium"
                  href="/resources/pronunciation-guide"
                >
                  Pronunciation Guide
                </Link>
              </div>
      ...
      <div className="my-3 px-4 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-sm text-neutral">
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-8 items-start sm:items-center">
          <p className="whitespace-nowrap">
            ©{currentYear} Studious Prep. All rights reserved.
          </p>
        ...
        <div className="flex gap-4 items-center">
          <a
            href="https://www.linkedin.com/company/studious-prep"
            target="_blank"
            rel="nofollow noopener"
            aria-label="Studious Prep LinkedIn"
            className="hover:text-gray-900"
          >
            <Linkedin className="w-5 h-5 fill-neutral" />
          </a>
          <a
            href="https://twitter.com/studiousprep"
            target="_blank"
            rel="nofollow noopener"
            aria-label="Studious Prep Twitter"
            className="hover:text-gray-900"
          >
            <Twitter className="w-5 h-5 fill-neutral" />
          </a>
          <a
            href="https://www.facebook.com/studiousprep"
            target="_blank"
            rel="nofollow noopener"
            aria-label="Studious Prep Facebook"
            className="hover:text-gray-900"
          >
            <svg className="w-5 h-5 fill-neutral" viewBox="0 0 24 24">
              <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.989C18.343 21.129 22 16.99 22 12z"/>
            </svg>
          </a>
          <a
            href="https://www.instagram.com/studiousprep"
            target="_blank"
            rel="nofollow noopener"
            aria-label="Studious Prep Instagram"
            className="hover:text-gray-900"
          >
            <svg className="w-5 h-5 fill-neutral" viewBox="0 0 24 24">
