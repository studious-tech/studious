            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">
                {searchQuery || selectedDifficulty 
                  ...
                  : `No ${getExamDisplayName(examId)} courses are currently available`
                }
              </p>
            </div>
          </CardContent>
          ...
          {sortedCourses.map((course) => (
            <CourseCard
              ...
              course={{
                ...
                progress: 0, // Real progress will be implemented later
                totalVideos: course.modules?.reduce((total, module) => 
                  total + (module.videos?.length || 0), 0) || 0,
                completedVideos: 0, // Real progress will be implemented later
              }}
